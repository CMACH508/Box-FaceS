...
from modules.layer_builders import ModulatedConv2d, NoiseInjection, Blur, Upsample, ModulatedConv2dRGB
...
class StyledConv(nn.Module):
    ...
    def forward(self, input, style, bbox, noise=None):
        out = self.conv(input, style, bbox)
